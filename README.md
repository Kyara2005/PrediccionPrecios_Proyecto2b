...
**Importante:** el modelo debe entrenarse al menos una vez llamando a `POST /entrenar` antes de poder usar `/predecir`. En el plan gratuito de Render el disco no es permanente, así que si el servicio se reinicia por inactividad, hay que volver a entrenar.
...
El dataset utilizado para entrenar el modelo fue **generado sintéticamente**, ya que no se encontró
un dataset público y estructurado sobre precios de vivienda en Quito. Los rangos de precios,
sectores considerados y la lógica de variación territorial se diseñaron tomando como referencia
los patrones reales documentados en el siguiente estudio:

> Ramos, W., Acosta, M. A., & Viana, A. F. (2025). *Patrones de vivienda en el DMQ: un estudio a
> partir de plataformas digitales* (Investigación N.º 07-2025-DES). Instituto de Investigaciones
> de la Ciudad, Alcaldía Metropolitana de Quito.
> https://investigaciones.quito.gob.ec/wp-content/uploads/2026/05/Patrones-de-vivienda-en-el-DMQ_-un-estudio-a-partir-de-plataformas-digitales-1-1.pdf

Este informe caracteriza la oferta de vivienda en venta y arriendo del Distrito Metropolitano de
Quito a partir de web scraping de Plusvalía, Facebook Marketplace y Airbnb, e identifica los
sectores con mayor dinamismo inmobiliario (Cumbayá, Iñaquito, Mariscal Sucre, Tumbaco, entre
otros), que sirvieron de guía para definir los sectores de nuestro dataset sintético.

**Nota:** al ser datos generados sintéticamente, los precios producidos por el modelo son
estimaciones con fines académicos y no deben interpretarse como valores reales de mercado.
